...
import org.fromheart.clockwork.getFormattedStopwatchTime

class StopwatchFlagAdapter : ListAdapter<StopwatchFlag, StopwatchFlagAdapter.StopwatchFlagViewHolder>(DiffCallback) {
